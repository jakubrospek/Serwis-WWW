        ...
        <div id="main">
            ...
            <section id="content">
            	...
            	<article id="text">
					...
					<p>
					<?php
							require_once('kodPHP/ListaKsiazekKonkretna.php');
					
							require_once('kodPHP/KsiazkaDane2Konkretna.php');
					?>
					</p>
				...
				|
				&nbsp
				<meter min="1" max="10" value="<?=$zaokraglenie?>" style="width:200px"></meter>&nbsp  <?=$zaokraglenie?>/10</p>
				</br>
                ...
                <article>
                    ...
                    <p>
						...
						<fieldset id="komentarz">
							<textarea id="komentarz" name="opinia" style="resize: none;" rows="10" value="<?php if (!empty($OPINIA)) echo $OPINIA; ?>">Komentarz...</textarea>

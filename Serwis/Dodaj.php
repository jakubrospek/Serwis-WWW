        ...
        <div id="main">
            ...
            <section id="content">
                ...
                <?php
					...
					require_once('kodPHP/DodajDane.php');
					
				?>
                	<h3>Dodawanie nowej pozycji</h3>
					<p>
					...
					<input type="hidden" name="MAX_FILE_SIZE" value="<?php echo MM_MAXFILESIZE; ?>" />
						<fieldset>
							...
							{
								echo '<img src="' . MM_UPLOADPATH . $stary_obraz . '"" />';
							}
							?>
							<p><textarea id="dodaj" name="Opis" type="text" style="resize: none;" rows="20" cols="80" value="<?php if (!empty($OPIS)) echo $OPIS; ?>">Opis...</textarea></p>
						</fieldset>
